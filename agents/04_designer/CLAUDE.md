...
[[07_frontend/CLAUDE|フロントエンドエージェント]] と連携してデザインから実装まで一貫してサポートする。
...
- [[07_frontend/CLAUDE|フロントエンドエージェント]] へのデザインハンドオフ（BUILD）
- UX レビュー・改善提案（QA）
...
デザイン完成後は [[07_frontend/CLAUDE|07_frontend]] と協力して実装品質を担保する:
