...
5. **ドキュメント更新 (SHIP)**: マージ後に README / SKILL.md / agent-registry.md を最新化する
...
| スキル | 用途 | スプリントフェーズ |
|--------|------|----------------|
| `plan-think` | 要求の背景を掘り下げ PLAN.md を作成 | THINK |
| `plan-review` | 技術設計・テスト計画の確定とユーザー承認 | PLAN |
| `route-agent` | ユーザーの指示からどのエージェントが適切か判断・割り振り | BUILD |
